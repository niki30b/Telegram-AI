...
def setting():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="API Keys", url="https://console.groq.com/keys")],
...
Visit this link: "<a href="URL">https://console.groq.com/keys</a>"
...
This bot lets you chat with an AI powered by Groq.

Getting started:
1. Press "Start set up".
2. Create and enter your Groq API key.
...
async def button_about(message: Message):
    await message.answer("""
AI Bot is a personal Telegram AI assistant powered by Groq.
