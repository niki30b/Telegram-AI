...
> 💡 You can find available models at [ollama.com/library](https://ollama.com/library)
...
|----------|-------------|
| `TOKEN_BOT` | Your Telegram bot token from [@BotFather](https://t.me/BotFather) |
...
3. Enter the **Ollama model name** you want to use (the one you pulled earlier)
4. Enter the behavior/instructions for your AI
5. Start chatting
...
The model is configured **per user during setup** via the Ollama model name.

You can change models or add new ones by pulling them in Ollama:
